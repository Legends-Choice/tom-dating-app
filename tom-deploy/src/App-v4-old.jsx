  ...
  return (
    <div style={{ flex: 1, overflowY: "auto", padding: "6px 20px 20px" }}>
      <div style={{ textAlign: "center", marginBottom: 16 }}>
        ...
        <button onClick={() => setManagingPhotos(true)} style={{ marginTop: 8, border: `2px solid ${T.lilacDeep}`, background: T.white, borderRadius: 999, padding: "7px 14px", cursor: "pointer", ...nu(800, 12.5, T.royal) }}>Manage photos</button>
      </div>
      {u.photos.length > 0 && (
